...
public function testAlgorithms():void
{
	try 
	{
		...
		*/
		...
		var arc4tve:Array = ARC4.encrypt(arc4tvk, arc4tvt);
		var arc4tvd:Array = ARC4.decrypt(arc4tvk, arc4tve);
		//
		var arc4key:Array = UTF8.textToBytes("1234567890123456");
		var arc4enc:Array = ARC4.encrypt(arc4key, utf8Bytes);
		var arc4dec:Array = ARC4.decrypt(arc4key, arc4enc);
		//
		...
		*/
		...
		var aes128tvd:Array = AES.decrypt(aes128tvk, aes128tve); // No unpadding needed.
		//
		...
		*/
		...
		var aes192tvd:Array = AES.decrypt(aes192tvk, aes192tve); // No unpadding needed.
		//
		...
		*/
		...
		var aes256tve:Array = AES.encrypt(aes256tvk, aes256tvt); // No padding needed.
		var aes256tvd:Array = AES.decrypt(aes256tvk, aes256tve); // No unpadding needed.
		//
