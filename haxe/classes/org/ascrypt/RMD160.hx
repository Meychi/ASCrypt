...
* RIPEMD-160 is a cryptographic hash function that computes a message digest of 160 bits.
* @author Mika Palmu
*/
class RMD160
{
	...
	*/
	...
	{
		var b:Array<Int> = UTIL.pack(bytes);
	...
	*/
	private static inline function core(x:Array<Int>, l:Int):Array<Int>
	{
		x[l >> 5] |= 0x80 << (l % 32);
		x[(((l + 64) >>> 9) << 4) + 14] = l;
		var i:Int = 0, h0:Int = 0x67452301, h1:Int = 0xefcdab89;
		var h2:Int = 0x98badcfe, h3:Int = 0x10325476, h4:Int = 0xc3d2e1f0;
		while (i < x.length)
		{
